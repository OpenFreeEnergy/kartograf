...
class _MappingShapeDistanceScorer(_AbstractAtomMappingScorer):
    ...
    def __init__(self, rd_shape_dist_func=rdShapeHelpers.ShapeTanimotoDist,
        ...
        """
        super().__init__()
        self._shape_dist_func = lambda molA, molB: rd_shape_dist_func(molA, molB, gridSpacing=grid_spacing,
                                                                      vdwScale=vdw_scale, ignoreHs=ignore_hs,
                                                                      maxLayers=max_layers, stepSize=step_size)
...
class MappingShapeOverlapScorer(_MappingShapeDistanceScorer):
    def __init__(self, grid_spacing=0.5, vdw_scale=0.8, ignore_hs=False, max_layers=-1, step_size=0.25):
        """
        ...
        super().__init__(rd_shape_dist_func=rdShapeHelpers.ShapeTanimotoDist,
...
class MappingShapeMismatchScorer(_MappingShapeDistanceScorer):
    ...
    def __init__(self, grid_spacing=0.5, vdw_scale=0.8, ignore_hs=False, max_layers=-1, step_size=0.25):
        ...
        super().__init__(rd_shape_dist_func=rdShapeHelpers.ShapeProtrudeDist,
                         grid_spacing=grid_spacing,
                         vdw_scale=vdw_scale,
                         ignore_hs=ignore_hs,
                         max_layers=max_layers,
